 ...
 * 2) 接收不到自定义消息
 */
public class PushJiGuangReceiver extends BroadcastReceiver {
    private static final String TAG = "JPush";
    @Override
    public void onReceive(Context context, Intent intent) {
        Bundle bundle = intent.getExtras();
        Log.d(TAG, "[JiGuangReceiver] onReceive - " + intent.getAction() + ", extras: " + printBundle(bundle));

        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            String regId = bundle.getString(JPushInterface.EXTRA_REGISTRATION_ID);
            Log.d(TAG, "[JiGuangReceiver] 接收Registration Id : " + regId);
    ...
    public void processCustomMessage(Context context, Bundle bundle) {
        ...
        sendBroadcast(context,extra_message);
    }

    public void sendBroadcast(Context c, String content) {
        Intent i = new Intent();
        i.setAction("com.push.core.RECEIVE_MESSAGE");
